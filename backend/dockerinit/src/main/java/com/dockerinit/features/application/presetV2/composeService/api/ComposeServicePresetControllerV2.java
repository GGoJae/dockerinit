...
import com.dockerinit.features.application.presetV2.composeService.materializer.ComposeServicePresetMaterializer;
...
@RestController
@RequestMapping("/api/presets-v2/compose-services")
@RequiredArgsConstructor
public class ComposeServicePresetControllerV2 {
    ...
    private final ServiceRendererV2 renderer;
    ...
    public ResponseEntity<ApiResponse<PresetDetailResponseV2>> get(
        ...
        PresetDetailResponseV2 dto = queryService.getDetail(PresetKind.COMPOSE_SERVICE, slug);
