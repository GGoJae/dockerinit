...
public final class ValidationErrors {
    ...
    public ValidationErrors throwDelayIf(boolean cond, String message) {
        this.cond = cond;
        this.message = message;
        return this;
    }

    public ValidationErrors throwDelayIf(boolean cond, String message, String field, Object value) {
        this.cond = cond;
        this.message = message;
        return add(field, this.message, value);
    }

    public ValidationErrors withField(String field, Object value) {
        if (!this.cond) return this;
        return add(field, this.message, value);
    }

    public ValidationErrors topMessage(String topMessage) {
        this.message = topMessage;
        return this;
    }

    public ValidationErrors add(String field, String message, Object rejectedValue) {
        return addDetail(field, message, null, null, rejectedValue);
    }

    public ValidationErrors addForList(String field, int index, String subfield,
                                       String message, Object rejectedValue) {
        return addDetail(field, message, subfield, index, rejectedValue);
    }

    public ValidationErrors requiredTrue(boolean cond, String field, String message, Object rejectedValue) {
        if (!cond) add(field, message, rejectedValue);
        return this;
    }

    public ValidationErrors rejectIf(boolean cond, String field, String message, Object rejectedValue) {
        if (cond) add(field, message, rejectedValue);
        return this;
    }

    public ValidationErrors notBlank(String field, String value, String message) {
        return requiredTrue(value != null && !value.isBlank(), field, message, value);
    }

    public ValidationErrors notNull(String field, Object value, String message) {
        return requiredTrue(value != null, field, message, value);
    }

    public ValidationErrors required(String field, String value, String message) {
        return requiredTrue(value != null && !value.isBlank(), field, message, value);
    }

    public ValidationErrors required(String field, Collection<?> value, String message) {
        return requiredTrue(value != null && !value.isEmpty(), field, message, value);
    }

    public ValidationErrors range(String field, Integer v, int min, int max, String message) {
        return requiredTrue(v != null && v >= min && v <= max, field, message, v);
    }

    public ValidationErrors matches(String field, String value, Pattern pattern, String message) {
        return requiredTrue(value != null && pattern.matcher(value).matches(), field, message, value);
    }

    public ValidationErrors lengthBetween(String field, String v, int min, int max, String msg) {
        return requiredTrue(v != null && v.length() >= min && v.length() <= max, field, msg, v);
    }

    public ValidationErrors sizeBetween(String field, Collection<?> v, int min, int max, String msg) {
        return requiredTrue(v != null && v.size() >= min && v.size() <= max, field, msg, v == null ? null : v.size());
    }

    public ValidationErrors required(String field, Map<?, ?> v, String msg) {
        return requiredTrue(v != null && !v.isEmpty(), field, msg, v);
    }

    public ValidationErrors required(String field, Object[] v, String msg) {
        return requiredTrue(v != null && v.length > 0, field, msg, v == null ? null : v.length);
    }

    public ValidationErrors positive(String field, Number v, String msg) {
        return requiredTrue(v != null && v.doubleValue() > 0, field, msg, v);
    }

    public ValidationErrors nonNegative(String field, Number v, String msg) {
        return requiredTrue(v != null && v.doubleValue() >= 0, field, msg, v);
    }

    public <T extends Comparable<T>> ValidationErrors between(String field, T v, T min, T max, String msg) {
        return requiredTrue(v != null && v.compareTo(min) >= 0 && v.compareTo(max) <= 0, field, msg, v);
    }

    public ValidationErrors noNullElements(String field, Collection<?> v, String msg) {
        return requiredTrue(v == null || v.stream().noneMatch(Objects::isNull), field, msg, v);
    }

    public ValidationErrors noBlankElements(String field, Collection<String> v, String msg) {
        return requiredTrue(v == null || v.stream().allMatch(s -> s != null && !s.isBlank()), field, msg, v);
    }

    public <T> ValidationErrors distinct(String field, Collection<T> v, String msg) {
        return requiredTrue(v == null || v.size() == new HashSet<>(v).size(), field, msg, v);
    }

    public ValidationErrors inSet(String field, String v, Set<String> allowed, String msg) {
        return requiredTrue(v != null && allowed.contains(v), field, msg, v);
    }

    public ValidationErrors notInSet(String field, String v, Set<String> banned, String msg) {
        return requiredTrue(v == null || !banned.contains(v), field, msg, v);
    }

    public <E extends Enum<E>> ValidationErrors inEnum(String field, String v, Class<E> e, boolean ignoreCase, String msg) {
        boolean ok = false;
        if (v != null) {
    ...
    public ValidationErrors exactlyOnePresent(String fieldA, Object a, String fieldB, Object b, String msg) {
        boolean ok = (a != null) ^ (b != null);
        return requiredTrue(ok, fieldA + "|" + fieldB, msg, (a != null ? fieldA : fieldB));
    }

    public ValidationErrors atLeastOnePresent(String msg, Map<String, Object> fields) {
        boolean ok = fields.values().stream().anyMatch(Objects::nonNull);
        return requiredTrue(ok, String.join("|", fields.keySet()), msg, null);
    }

    public ValidationErrors implies(boolean premise, boolean conclusion, String field, String msg) {
        return requiredTrue(!premise || conclusion, field, msg, null);
    }

    public <K, V> ValidationErrors forEachValueRejectIf(String field, Map<K, V> map, Predicate<V> invalid, String message) {
    ...
    public <T> ValidationErrors forEachRejectIf(String field, List<T> list, Predicate<? super T> invalid, String message) {
    ...
    public <K,V> ValidationErrors forEachEntryRejectIf(String field, Map<K,V> map, BiPredicate<K,V> invalid, String msg) {
        if (map == null) return this;
    ...
    public void judge() {
        if (cond) {
            if (errors.isEmpty()) {
                errors.put("_", List.of(ErrorContent.of(this.message, null, null, null)));
            }
            Map<String, List<ErrorContent>> ro = toReadOnly(errors);
            throw new InvalidInputCustomException(this.message, ro);
        }
    ...
    private ValidationErrors addDetail(String field, String message,
