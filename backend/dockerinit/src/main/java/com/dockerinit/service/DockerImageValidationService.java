...
import com.dockerinit.exception.CustomException.RateLimitExceededException;
...
import static com.dockerinit.constant.UrlInfo.DOCKER_HUB_API;
        ...
        try {
            ...
            webClient.get()
                    ...
                    .onStatus(status -> status == HttpStatus.TOO_MANY_REQUESTS,
                            res -> Mono.error(new RateLimitExceededException("도커 허브 요청 제한 초과")))
