...
class ZipPackagerTest {
    ...
    void is_same_etag_when_same_file_in_package() throws Exception{
        GeneratedFile a = new GeneratedFile("a.txt", "hello".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile b = new GeneratedFile("b.txt", "world".getBytes(), ContentType.TEXT, false, FileType.README);
    ...
    void is_not_same_etag_when_different_file_in_package() throws Exception{
        GeneratedFile a = new GeneratedFile("a.txt", "hello".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile b = new GeneratedFile("b.txt", "world".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile c = new GeneratedFile("c.txt", "java".getBytes(), ContentType.TEXT, false, FileType.README);
    ...
    void etag_changes_when_content_difference() {
        GeneratedFile a1 = new GeneratedFile("a.txt", "hello".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile a2 = new GeneratedFile("a.txt", "hello!".getBytes(), ContentType.TEXT, false, FileType.README);
    ...
    void default_package_name_when_blank() {
        GeneratedFile a = new GeneratedFile("a.txt", "x".getBytes(), ContentType.TEXT, false, FileType.README);
    ...
    void sensitive_flag_bubbles_up() {
        GeneratedFile safe = new GeneratedFile("a.txt", "x".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile secret = new GeneratedFile("secret.env", "TOKEN=xxx".getBytes(), ContentType.TEXT, true, FileType.ENV);
    ...
    void duplicate_file_names_get_unq_filename() throws Exception{
        GeneratedFile f1 = new GeneratedFile("text.txt", "a".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile f2 = new GeneratedFile("text.txt", "b".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile f3 = new GeneratedFile("text.txt", "c".getBytes(), ContentType.TEXT, false, FileType.README);
    ...
    void numbered_suffix_before_last_extension() throws Exception {
        GeneratedFile f1 = new GeneratedFile("archive.tar.gz", "1".getBytes(), ContentType.OCTET, false, FileType.README);
        GeneratedFile f2 = new GeneratedFile("archive.tar.gz", "2".getBytes(), ContentType.OCTET, false, FileType.README);
    ...
    void path_sanitization_rules() throws Exception {
        GeneratedFile f1 = new GeneratedFile("/root/../etc/hosts", "x".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile f2 = new GeneratedFile("a\\b\\c.txt", "y".getBytes(), ContentType.TEXT, false, FileType.README);
    ...
    void streamingPackaging_largeFile_switchesToStreamingAndSetsLength() {
        ...
        GeneratedFile bigFile = new GeneratedFile("big.bin", big, ContentType.OCTET, false, FileType.README);
    ...
    void sanitize_and_dedup_names() throws Exception {
        GeneratedFile x = new GeneratedFile("../../etc/passwd", "x".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile y = new GeneratedFile("/abs/path\\to\\file.txt", "y".getBytes(), ContentType.TEXT, false, FileType.README);
        GeneratedFile dup = new GeneratedFile("file.txt", "z".getBytes(), ContentType.TEXT, false, FileType.README);
    ...
    @Test void windows_drive_prefix_removed() throws Exception {
        GeneratedFile f = new GeneratedFile("C:\\temp\\x.txt", "x".getBytes(), ContentType.TEXT, false, FileType.README);
    ...
    @Test void dotdot_collapses_safely() throws Exception {
        GeneratedFile f = new GeneratedFile("a/./b/../../c/../d/e.txt", "x".getBytes(), ContentType.TEXT, false, FileType.README);
        var p = packager.packageFiles(List.of(f), "pkg");
        var zip = p.fold(bs -> bs, s -> {
            try {
                return s.get().readAllBytes();
